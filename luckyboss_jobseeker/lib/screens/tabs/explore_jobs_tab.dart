...
class _ExploreJobsTabState extends State<ExploreJobsTab> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        Provider.of<JobSeekerProvider>(context, listen: false).syncWithBackend();
      }
    });
  }
                            ...
                            if (_unreadNotifications > 0)
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text('$_unreadNotifications', style: GoogleFonts.inter(fontSize: 9, fontWeight: FontWeight.bold, color: Colors.white)),
                                ),
                              ),
                          ],
                        ),
