                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    '${job.aiMatchPercent.toInt()}% AI Fit',
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10),
                              _buildFitMeter('Technical Skills Alignment', 0.96, '96%'),
                              const SizedBox(height: 6),
                              _buildFitMeter('Experience & Seniority Fit', 0.92, '92%'),
                              const SizedBox(height: 6),
                              _buildFitMeter('Cross-Border Compliance & Location', 1.0, '100%'),
                            ],
                          ),
                        ),
