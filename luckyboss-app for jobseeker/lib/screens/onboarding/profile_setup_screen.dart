...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  // --- Real / Realistic Resume File Upload Dialog ---
  void _promptResumeUpload() {
    final fileNameCtrl = TextEditingController(text: '${_nameController.text.trim().replaceAll(' ', '_')}_Resume.pdf');
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Select Resume Document', style: GoogleFonts.cormorantGaramond(fontSize: 22, fontWeight: FontWeight.bold, color: AppTheme.primaryNavy)),
                const SizedBox(height: 6),
                Text('Upload PDF or DOCX to extract skills and experience automatically.', style: AppTheme.sansRegular(fontSize: 12.5, color: AppTheme.textMuted)),
                const SizedBox(height: 16),
                TextField(
                  controller: fileNameCtrl,
                  decoration: InputDecoration(
                    labelText: 'File Name',
                    prefixIcon: const Icon(Icons.picture_as_pdf_rounded, color: Color(0xFFDC2626)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.pop(ctx);
                      _executeResumeExtraction(fileNameCtrl.text.trim());
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppTheme.primaryNavy,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
                    ),
                    child: Text('Process & Extract with AI', style: AppTheme.sansBold(fontSize: 14, color: Colors.white)),
                  ),
                ),
              ],
            ),
    ...
    return ListView(
      ...
      children: [
        ...
        SizedBox(
          ...
          height: 54,
          child: ElevatedButton(
            onPressed: _showNotificationPermissionModal,
            style: ElevatedButton.styleFrom(
              backgroundColor: AppTheme.primaryNavy,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            ),
