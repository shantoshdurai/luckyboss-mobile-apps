...
class MetaText extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Text(
        text.toUpperCase(),
        style: AppTheme.meta(color: color ?? AppTheme.inkFaint, size: size),
      );
}
            ...
            Row(
              ...
              children: [
                ...
                if (onExplain != null) ...[
                  ...
                  Icon(Icons.unfold_more, size: 11, color: AppTheme.inkFaint),
                ],
              ],
            ),
...
class CreditMeter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = low ? AppTheme.signalAttention : AppTheme.inkMuted;
    ...
    return Row(
      ...
      children: [
        ...
        Text('/$total', style: AppTheme.meta(color: AppTheme.inkFaint, size: 10)),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) => Tooltip(
        ...
        child: InkWell(
          ...
          child: SizedBox(
            width: 44,
            height: 44,
            child: Icon(icon, size: 17, color: AppTheme.inkMuted),
          ),
        ),
      );
}
    ...
    final mark = Stack(
      ...
      children: [
        Icon(Icons.auto_awesome_outlined,
            size: compact ? 17 : 19, color: live ? AppTheme.ink : AppTheme.inkFaint),
        Positioned(
          right: -2,
          top: -2,
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: live ? null : AppTheme.inkFaint,
            ),
          ),
        ),
      ],
        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Text('Lucky AI',
                    style: AppTheme.button(color: live ? AppTheme.ink : AppTheme.inkFaint)),
                if (!live) ...[
  ...
  Widget build(BuildContext context) => Center(
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Container(width: 28, height: AppTheme.hairline, color: AppTheme.rule),
              const SizedBox(height: 18),
